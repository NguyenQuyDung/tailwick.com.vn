...
var options = {
    ...
    plotOptions: {
        candlestick: {
            colors: {
                upward: getChartColorsArray("basicChart")[0],
                downward: getChartColorsArray("basicChart")[1],
            }
        }
    },
    xaxis: {
...
var options = {
    ...
    plotOptions: {
        candlestick: {
            colors: {
                upward: getChartColorsArray("combo_candlestick")[0],
                downward: getChartColorsArray("combo_candlestick")[1],
            }
        }
    },
    xaxis: {
        ...
        bar: {
            ...
            colors: {
                ranges: [{
                    from: -1000,
                    to: 0,
                    color: getChartColorsArray("combo_candlestick_chart")[0]
                }, {
                    from: 1,
                    to: 10000,
                    color: getChartColorsArray("combo_candlestick_chart")[1]
                }],
...
var options = {
        ...
        xaxis: [
            {
                ...
                label: {
                    ...
                    style: {
                        fontSize: '12px',
                        color: '#fff',
                        background: getChartColorsArray("categoryCandlestick")[2]
                    },
    ...
    plotOptions: {
        candlestick: {
            colors: {
                upward: getChartColorsArray("categoryCandlestick")[0],
                downward: getChartColorsArray("categoryCandlestick")[1],
            }
        }
    },
    tooltip: {
...
var chart = new ApexCharts(document.querySelector("#categoryCandlestick"), options);
chart.render();
...
var options = {
    ...
    plotOptions: {
        candlestick: {
            colors: {
                upward: getChartColorsArray("candlestickWithLine")[0],
                downward: getChartColorsArray("candlestickWithLine")[1],
            }
        }
    },
    tooltip: {
...
var chart = new ApexCharts(document.querySelector("#candlestickWithLine"), options);
chart.render();