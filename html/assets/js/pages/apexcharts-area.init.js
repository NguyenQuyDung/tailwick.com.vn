...
var options = {
    ...
    colors: getChartColorsArray("basicArea"),
...
var options = {
    ...
    colors: getChartColorsArray("splineChart"),
    xaxis: {
        type: 'datetime',
...
var options = {
    ...
    colors: getChartColorsArray("dateTimeChart"),
    fill: {
        type: 'gradient',
        gradient: {
            shadeIntensity: 1,
...
var chart = new ApexCharts(document.querySelector("#dateTimeChart"), options);
chart.render();
...
var options = {
    ...
    colors: getChartColorsArray("chartNegativeValues"),
    tooltip: {
        x: {
            format: "yyyy",
        },
...
var chart = new ApexCharts(document.querySelector("#chartNegativeValues"), options);
chart.render();
...
var options = {
    ...
    colors: getChartColorsArray("areaMonthsChart"),
    stroke: {
        width: 0,
        curve: 'smooth'
    },
...
var chart = new ApexCharts(document.querySelector("#areaMonthsChart"), options);
chart.render();
...
var optionsYears = {
    ...
    colors: getChartColorsArray("areaYearsChart"),
    dataLabels: {
        enabled: false
    },
    stroke: {
...
var chartYears = new ApexCharts(document.querySelector("#areaYearsChart"), optionsYears);
chartYears.render();
...
var options = {
    ...
    colors: getChartColorsArray("chartStacked"),
    dataLabels: {
        enabled: false
    },
    stroke: {
...
var options = {
    ...
    colors: getChartColorsArray("chartIrregular"),
    fill: {
        type: 'gradient',
        gradient: {
            shadeIntensity: 1,
...
var chart = new ApexCharts(document.querySelector("#chartIrregular"), options);
chart.render();
...
var options = {
    ...
    colors: getChartColorsArray("chartMissingNullValues"),
    markers: {
        size: 5,
        hover: {
            size: 9
...
var chart = new ApexCharts(document.querySelector("#chartMissingNullValues"), options);
chart.render();